...
- Ahzidal's Enchanted Armor - Just made it inconsistent with Dragon Priest Armor
...
- Added circlet slots to all circlets, helmets and hoods.
...
- Flickering torches on the road
- Navmesh around Kynesgrove
- Water now properly gives a food buff, although I've reduced it to 10% since food is so much stronger than it once was
- Moon monk gauntlets have proper keywords
...
- Blood mage now reduces health by 2 per level instead of 20% overall (which was affecting enchantments)
...
- Quester now only counts each quest once (e.g. 1 type of missive) and only works on non-misc quests. However, it gives 2 stats per quest. 
- Silent Dovah is now 2 souls per buff. Speech and intimidation checks almost always fail.
- Soul Reaver is now 15% enchantment boost but 20% weapon/armor reduction
...
- Vampire Armor and clothing expansion armors can be bought from the Volkihar merchant. They also now require joining the Volkihar to craft. Also, the armors are crafted with advanced blacksmithing (and benefit from advanced tempering). The heavy armor has a new "heavy vampire armor" keyword.
...
- Tempering Craftsmanship 1.5 --> 1.3
- Tempering Dwarven/Advanced Light Smithing/Advanced 1.6 --> 1.35
- Tempering Elven/Orcish Smithing 1.7 --> 1.4
...
- Chitin 9% Ranged Res
- Daedric/Ancient Falmer 6% Magic Res
- Dawnguard 21%/10.5% Vampiric Drain/Vampiric Physical Res
- Dwarven 6% Blunt Res
- Glass/Ebony/Stalhrim 9% Shock/Fire/Frost Resist - Skaal also 9% Frost
- Elven/Nordic 2.5% Magic Magnitude
- Draconic 5% Shout CDR
- Guard/Hide +10/10% Stamina/Stamina Regen
- Iron/Remnant 3.5% Fire/Shock Res
- Netch/Akaviri 3% Movement
- Nightingale/Ancient Shrouded 2% Movement Speed/Magic Res
- Bonemold/Leather 7% Shock Res - Fur 7% Frost Res
- Linwe's/Shrouded 25%/20% less stamina when moving while sneaking
- Orcish +6 Stamina/Armor Rating
- Scale 3% Magic Res
- Falmer 15% Poison Res
- Forsworn 7% Alteration Cost
- Wolf 1% Movement Speed/Damage Reflection
- Ancient Nordic 2.5% Shour CDR
- Imperial/Steel/Stormcloak +5 Health
- Vigilant Corrupted 10% Silver Res
- Silverhand 10.5% Werewolf Res
- Silver 8% Undear/Werwolf Res
- Penitus 5% illusion cost
- Vampire 20% Stronger Vampiric Drain

- New Smithing level requirements. This makes lvl 35 Daedric/Draconic possible with smart use of Oghma.
- T1: 10 (Craftsmanship) 
...
- Shadow Shaping: 1.25x magnitude, 1.25x duration, 0.9x cost for shadow spells
- Deceptive Image: 25% chance to take no physical damage and 25% chance to ignore 50% of enemy's armor rating while perceptual illusion spells are active
- Perceptual Illusions: 1.25x magnitude, 1.25x duration, 0.9x cost for perceptual spells
- Mesmerize: Increased success chance and 2x duration for emotional illusion spells
- Emotional Illusions: Increased success chance, 1.25x magnitude, 1.25x duration, 0.9x cost for emotional spells
- Curse: 1.25x physical damage, spell magnitude, and spell duration on targets under delusive illusion effects
- Delusive Illusions: Increased success chance, 1.25x magnitude, 1.25x duration, 0.9x cost for delusive spells
...
- Birthsign: The Lord: Gain 15% Magic Resist and q50 armor rating, restore 1.5 health per second, gain 30% Weakness to Fire.
...
- Birthsign: The Tower: Gain more gold when killing enemies, 50 more carryweight, lockpicking expertise is increased by 4, you can pick effortless locks in plain sight without being noticed, reflect 15% physical damage.
...
- Changed several VIGILANT armors as part of an ongoing project to make it more lore friendly.
